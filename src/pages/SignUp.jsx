    ...
    <div>
      ...
      <div className="relative px-8 py-12 bg-white rounded-lg text-left w-full max-w-lg overflow-hidden">
        ...
        <div className="relative z-10">
          <h3 className="mb-8 text-xl font-medium text-center">Create an Account And Be Learner</h3>
          <form onSubmit={handleSubmit}>
            <div className="mb-10">
              ...
              <div className="text-gray-700 text-center mb-8">Or, sign up with your email</div>
