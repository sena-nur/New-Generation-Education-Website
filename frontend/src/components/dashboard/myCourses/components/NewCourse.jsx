...
const NewCourse = ({ selectedId }) => {
  ...
  const data = selectedData.filter((item) => item.id === selectedId)[0];
          ...
          return (
            ...
            >
              ...
              <div className="flex gap-4  ">
                ...
                >
                  <FaEdit className="w-4 h-4 fill-custom-orange" />
                </button>
              </div>
            </div>
          );
            ...
            <div className="grid grid-cols-2 relative">
              <div className="absolute right-10">
                <div className="flex gap-2">
                  <div className="bg-orange-600 text-center items-center flex text-text-white rounded-full">
                    <button className="py-2 px-6">Publish</button>
                  </div>
                  <div>
                    <button className="bg-red-500 p-3  rounded-full">
                      <FaTrash className="fill-text-white" />
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className=" mx-6  ">
                ...
                <div className="flex justify-center">
                  <button className=" bg-custom-orange text-xl text-white py-3 px-6 rounded-md mt-8">
                    Update
                  </button>
                </div>
              </div>
...
const style = {
  ...
  sectionContainer: "bg-deep2-orange shadow-lg px-6 py-4 rounded-md",
